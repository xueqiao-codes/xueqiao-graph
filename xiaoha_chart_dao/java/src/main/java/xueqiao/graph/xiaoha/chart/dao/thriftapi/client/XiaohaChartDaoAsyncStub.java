...
public class XiaohaChartDaoAsyncStub extends BaseStub { 
  ...
  public long updateTag(int routeKey, int timeout, xueqiao.graph.xiaoha.chart.thriftapi.XueQiaoTag tag, IMethodCallback<XiaohaChartDao.updateTag_args, XiaohaChartDao.updateTag_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_updateTagCall(AsyncCallRunner runner, int routeKey, int timeout, xueqiao.graph.xiaoha.chart.thriftapi.XueQiaoTag tag, IMethodCallback<XiaohaChartDao.updateTag_args, XiaohaChartDao.updateTag_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_updateTagServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, xueqiao.graph.xiaoha.chart.thriftapi.XueQiaoTag tag){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    XiaohaChartDao.updateTag_args request = new XiaohaChartDao.updateTag_args();
    request.setPlatformArgs(platformArgs);
    request.setTag(tag);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("updateTag");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(XiaohaChartDao.updateTag_result.class);
    return serviceCall;
  }
  ...
  public long reqTagPage(int routeKey, int timeout, xueqiao.graph.xiaoha.chart.thriftapi.ReqTagOption option, org.soldier.platform.page.IndexedPageOption pageOption, IMethodCallback<XiaohaChartDao.reqTagPage_args, XiaohaChartDao.reqTagPage_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_reqTagPageCall(AsyncCallRunner runner, int routeKey, int timeout, xueqiao.graph.xiaoha.chart.thriftapi.ReqTagOption option, org.soldier.platform.page.IndexedPageOption pageOption, IMethodCallback<XiaohaChartDao.reqTagPage_args, XiaohaChartDao.reqTagPage_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqTagPageServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, xueqiao.graph.xiaoha.chart.thriftapi.ReqTagOption option, org.soldier.platform.page.IndexedPageOption pageOption){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    XiaohaChartDao.reqTagPage_args request = new XiaohaChartDao.reqTagPage_args();
    request.setPlatformArgs(platformArgs);
    request.setOption(option);
    request.setPageOption(pageOption);
    serviceCall.setRequest(request);
    ...
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(XiaohaChartDao.reqTagPage_result.class);
    return serviceCall;
  }
