...
public class ReqChartOption implements org.apache.thrift.TBase<ReqChartOption, ReqChartOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqChartOption> {
   ...
   * @see ChartState
   */
  public ChartState state; // optional
  ...
  private _Fields optionals[] = {_Fields.CHART_IDS,_Fields.XIAOHA_OBJ_ID,_Fields.PARENT_FOLDER_ID,_Fields.CHART_TYPE,_Fields.COMMODITY_NAME,_Fields.PLATE,_Fields.STATE,_Fields.NAME,_Fields.KEY_WORDS};
   ...
   * @see ChartState
   */
  public ReqChartOption setState(ChartState state) {
    this.state = state;
    return this;
  }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqChartOption struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 9: // STATE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.state = ChartState.findByValue(iprot.readI32());
