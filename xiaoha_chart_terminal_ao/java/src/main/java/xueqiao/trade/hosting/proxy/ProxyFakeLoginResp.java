...
public class ProxyFakeLoginResp implements org.apache.thrift.TBase<ProxyFakeLoginResp, ProxyFakeLoginResp._Fields>, java.io.Serializable, Cloneable, Comparable<ProxyFakeLoginResp> {
  ...
  private _Fields optionals[] = {_Fields.COMPANY_GROUPS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.companyGroups = new ArrayList<ProxyCompanyGroup>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  ProxyCompanyGroup _elem10;
                  _elem10 = new ProxyCompanyGroup();
                  _elem10.read(iprot);
                  struct.companyGroups.add(_elem10);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.companyGroups != null) {
        if (struct.isSetCompanyGroups()) {
          oprot.writeFieldBegin(COMPANY_GROUPS_FIELD_DESC);
          {
            ...
            for (ProxyCompanyGroup _iter11 : struct.companyGroups)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetCompanyGroups()) {
        {
          ...
          for (ProxyCompanyGroup _iter12 : struct.companyGroups)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.companyGroups = new ArrayList<ProxyCompanyGroup>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            ProxyCompanyGroup _elem15;
            _elem15 = new ProxyCompanyGroup();
            _elem15.read(iprot);
            struct.companyGroups.add(_elem15);
          }
        }
        struct.setCompanyGroupsIsSet(true);
      }
