            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updateNotes = new ArrayList<String>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  String _elem26;
                  _elem26 = iprot.readString();
                  struct.updateNotes.add(_elem26);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.updateNotes != null) {
        if (struct.isSetUpdateNotes()) {
          oprot.writeFieldBegin(UPDATE_NOTES_FIELD_DESC);
          {
            ...
            for (String _iter27 : struct.updateNotes)
            {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.updateNotes = new ArrayList<String>(_list29.size);
          for (int _i30 = 0; _i30 < _list29.size; ++_i30)
          {
            String _elem31;
            _elem31 = iprot.readString();
            struct.updateNotes.add(_elem31);
          }
        }
        struct.setUpdateNotesIsSet(true);
      }
