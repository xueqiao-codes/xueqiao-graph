              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.hostingMessageIds = new HashSet<Long>(2*_set40.size);
                  for (int _i41 = 0; _i41 < _set40.size; ++_i41)
                  {
                    long _elem42;
                    _elem42 = iprot.readI64();
                    struct.hostingMessageIds.add(_elem42);
                  }
                  iprot.readSetEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, markMessageAsRead_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.hostingMessageIds != null) {
          oprot.writeFieldBegin(HOSTING_MESSAGE_IDS_FIELD_DESC);
          {
            ...
            for (long _iter43 : struct.hostingMessageIds)
            {
        ...
        if (struct.isSetHostingMessageIds()) {
          {
            ...
            for (long _iter44 : struct.hostingMessageIds)
            {
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.hostingMessageIds = new HashSet<Long>(2*_set45.size);
            for (int _i46 = 0; _i46 < _set45.size; ++_i46)
            {
              long _elem47;
              _elem47 = iprot.readI64();
              struct.hostingMessageIds.add(_elem47);
            }
          }
          struct.setHostingMessageIdsIsSet(true);
        }
