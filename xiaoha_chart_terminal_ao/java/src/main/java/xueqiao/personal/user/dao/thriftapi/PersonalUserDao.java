              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<xueqiao.personal.user.thriftapi.PersonalUserEntry>(_list32.size);
                  for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                  {
                    xueqiao.personal.user.thriftapi.PersonalUserEntry _elem34;
                    _elem34 = new xueqiao.personal.user.thriftapi.PersonalUserEntry();
                    _elem34.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reqPersonalUser_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (xueqiao.personal.user.thriftapi.PersonalUserEntry _iter35 : struct.success)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (xueqiao.personal.user.thriftapi.PersonalUserEntry _iter36 : struct.success)
            {
              _iter36.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<xueqiao.personal.user.thriftapi.PersonalUserEntry>(_list37.size);
            for (int _i38 = 0; _i38 < _list37.size; ++_i38)
            {
              xueqiao.personal.user.thriftapi.PersonalUserEntry _elem39;
              _elem39 = new xueqiao.personal.user.thriftapi.PersonalUserEntry();
              _elem39.read(iprot);
    ...
    private static class reqUserRelateInfo_resultStandardScheme extends StandardScheme<reqUserRelateInfo_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<xueqiao.personal.user.thriftapi.UserRelateInfo>(_list40.size);
                  for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                  {
                    xueqiao.personal.user.thriftapi.UserRelateInfo _elem42;
                    _elem42 = new xueqiao.personal.user.thriftapi.UserRelateInfo();
                    _elem42.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reqUserRelateInfo_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (xueqiao.personal.user.thriftapi.UserRelateInfo _iter43 : struct.success)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class reqUserRelateInfo_resultTupleScheme extends TupleScheme<reqUserRelateInfo_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, reqUserRelateInfo_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (xueqiao.personal.user.thriftapi.UserRelateInfo _iter44 : struct.success)
            {
              _iter44.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<xueqiao.personal.user.thriftapi.UserRelateInfo>(_list45.size);
            for (int _i46 = 0; _i46 < _list45.size; ++_i46)
            {
              xueqiao.personal.user.thriftapi.UserRelateInfo _elem47;
              _elem47 = new xueqiao.personal.user.thriftapi.UserRelateInfo();
              _elem47.read(iprot);
    ...
    private static class reqFavoriteFolder_resultStandardScheme extends StandardScheme<reqFavoriteFolder_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<xueqiao.personal.user.thriftapi.FavoriteFolder>(_list48.size);
                  for (int _i49 = 0; _i49 < _list48.size; ++_i49)
                  {
                    xueqiao.personal.user.thriftapi.FavoriteFolder _elem50;
                    _elem50 = new xueqiao.personal.user.thriftapi.FavoriteFolder();
                    _elem50.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reqFavoriteFolder_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (xueqiao.personal.user.thriftapi.FavoriteFolder _iter51 : struct.success)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class reqFavoriteFolder_resultTupleScheme extends TupleScheme<reqFavoriteFolder_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, reqFavoriteFolder_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (xueqiao.personal.user.thriftapi.FavoriteFolder _iter52 : struct.success)
            {
              _iter52.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<xueqiao.personal.user.thriftapi.FavoriteFolder>(_list53.size);
            for (int _i54 = 0; _i54 < _list53.size; ++_i54)
            {
              xueqiao.personal.user.thriftapi.FavoriteFolder _elem55;
              _elem55 = new xueqiao.personal.user.thriftapi.FavoriteFolder();
              _elem55.read(iprot);
    ...
    private static class reqFavoriteChart_resultStandardScheme extends StandardScheme<reqFavoriteChart_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<xueqiao.personal.user.thriftapi.FavoriteChart>(_list56.size);
                  for (int _i57 = 0; _i57 < _list56.size; ++_i57)
                  {
                    xueqiao.personal.user.thriftapi.FavoriteChart _elem58;
                    _elem58 = new xueqiao.personal.user.thriftapi.FavoriteChart();
                    _elem58.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reqFavoriteChart_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (xueqiao.personal.user.thriftapi.FavoriteChart _iter59 : struct.success)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class reqFavoriteChart_resultTupleScheme extends TupleScheme<reqFavoriteChart_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, reqFavoriteChart_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (xueqiao.personal.user.thriftapi.FavoriteChart _iter60 : struct.success)
            {
              _iter60.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<xueqiao.personal.user.thriftapi.FavoriteChart>(_list61.size);
            for (int _i62 = 0; _i62 < _list61.size; ++_i62)
            {
              xueqiao.personal.user.thriftapi.FavoriteChart _elem63;
              _elem63 = new xueqiao.personal.user.thriftapi.FavoriteChart();
              _elem63.read(iprot);
